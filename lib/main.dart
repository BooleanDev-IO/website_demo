        ...
        body: Stack(
          children: [
            ...
            PageView.custom(
              ...
              childrenDelegate: SliverChildBuilderDelegate(childCount: menu.length + 1, (context, index) {
                switch (index) {
                  case 0:
            ...
            Positioned(
              bottom: 20,
              left: size.width < 1140 ? 26.0 : 200.0,
              right: size.width < 1140 ? 26.0 : 200.0,
              child: Theme(
                ...
                child: AdaptiveNavBar(
                  ...
                  onTitleTapped: () {
                    controller.animateToPage(0, duration: Duration(milliseconds: 600), curve: Curves.easeInOut);
                  },
